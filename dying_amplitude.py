...
x_max = 15.0  # Maximum x value
absorption_strength = 0.1  # Strength of absorption
...
def animate(t):
    ...
    # Apply complex absorbing potential only once
    if x_shifted >= 10:
        psi *= np.exp(-1j * absorption_strength * (x - x_max))
